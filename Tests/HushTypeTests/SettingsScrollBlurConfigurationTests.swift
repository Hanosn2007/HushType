...
final class SettingsScrollBlurConfigurationTests: XCTestCase {
    func testPreviewDefaultsAndValidatedOverrides() throws {
        ...
        XCTAssertEqual(SettingsScrollBlurConfiguration.load(defaults: defaults, isPreview: false), preview)
        ...
        XCTAssertEqual(SettingsScrollBlurConfiguration.load(defaults: defaults, isPreview: false), overridden)
