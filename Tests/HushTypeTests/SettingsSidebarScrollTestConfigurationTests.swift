...
final class SettingsSidebarScrollTestConfigurationTests: XCTestCase {
    func testFillerRowsAreOffByDefaultAndRespectTheSameExplicitSettingInStable() throws {
        ...
        XCTAssertTrue(SettingsSidebarScrollTestConfiguration.isEnabled(defaults: defaults, isPreview: false))
